...
#define UIDKEYCHAIN_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
// Keychain access group available at compile time
#define UIDKEYCHAIN_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef UIDKEYCHAIN_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, UIDKeychainQuerySynchronizationMode) {
    UIDKeychainQuerySynchronizationModeAny,
    UIDKeychainQuerySynchronizationModeNo,
    UIDKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface UIDKeychainQuery : NSObject
...
@property (nonatomic) UIDKeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/**
 ...
 UIDKEYCHAIN_SYNCHRONIZATION_AVAILABLE is only for compile time. If you are checking for the presence of synchronization,
