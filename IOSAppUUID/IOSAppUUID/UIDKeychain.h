...
/**
 Error code specific to UIDKeychain that can be returned in NSError objects.
 For codes returned by the operating system, refer to SecBase.h for your
 platform.
 */
typedef NS_ENUM(OSStatus, UIDKeychainErrorCode) {
    /** Some of the arguments were invalid. */
    UIDKeychainErrorBadArguments = -1001,
};

/** UIDKeychain error domain */
extern NSString *const kUIDKeychainErrorDomain;

/** Account name. */
extern NSString *const kUIDKeychainAccountKey;
 ...
 */
extern NSString *const kUIDKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kUIDKeychainClassKey;

/** Item description. */
extern NSString *const kUIDKeychainDescriptionKey;

/** Item label. */
extern NSString *const kUIDKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kUIDKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kUIDKeychainWhereKey;
...
/**
 ...
 UIDKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface UIDKeychain : NSObject
...
/**
 ...
 See the `NSString` constants declared in UIDKeychain.h for a list of keys that can be used when accessing the
...
//#import <UIDKeychain/UIDKeychainQuery.h>
